...
`
Statement #2:
JavaScript was hard to learn.
`,
`
Statement #3:
JavaScript is harder to learn than css and html.
`,
`
Statement #4:
JavaScript was fun to learn.
`,
`
Statement #5:
...
function quizComponent () {
  ...
  function sendData(results) {
    var request  = {
      url          : 'https://quiz-af145.firebaseio.com/results.json',
      method       : 'POST',
  ...
  function createChart(ctx, myData) {
    minixhr('https://quiz-af145.firebaseio.com/results.json', responseHandler)
